...
print("Время выполнения блока шифровки: ",timeit.timeit() )
# Підрахування часу  виконування блока шифроки 
...
print("Время выполнения блока дешифровки: ", timeit.timeit())
# Підрахування часу  виконування блока дешифроки 
