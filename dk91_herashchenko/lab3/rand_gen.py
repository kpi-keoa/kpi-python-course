...
def translator(value):
    ...
    return translit(value, language_code=LANGHT, reversed=True)


def parse_students(filename, lang=LANGHT):
    '''Opens a yaml file, and writes the group and student names translated into English as a dictionary.
