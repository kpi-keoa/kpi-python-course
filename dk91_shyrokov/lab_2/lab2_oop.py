class MusicalGroup():
    def __init__(self,  singer, song, group_name=None):
...
class Song(MusicalGroup):
    def __init__(self, group_name, singer, song, topic, main_character):
            super(). __init__(self, group_name, singer, song)
            self.topic = topic
...
class Sense(Song):
     def __init__(self, group_name, singer, song, topic, main_character, sense="passion and its consequences."):
            super(). __init__(self, group_name, singer, song, topic, main_character)
            self.sense = sense
...
if __name__ == '__main__':  
        group = MusicalGroup("King and the Clown", "Andrew Knyazev (Knyaz)", "Joker")
        group.what_the_song()
